...
import requests
from gtts import gTTS  # 백업용

MAX_TTS_LENGTH = 100  

# === CLOVA 설정 ===
CLOVA_CLIENT_ID = "zxc5124412"
CLOVA_CLIENT_SECRET = "asd5124412"
CLOVA_SPEAKER = "nyeji" # 예지  # 기본 목소리, 아래 목록 참고
CLOVA_SPEED = 0  # -5 ~ 5
CLOVA_PITCH = 0
        ...
        async with lock:
            ...
            try:
                ...
                if r.status_code != 200:
                    raise Exception(f"CLOVA 오류 {r.status_code}: {r.text}")
